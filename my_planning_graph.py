# -*- coding: utf-8 -*-
"""
Created on Sat Oct 21 23:17:44 2017
...
class PlanningGraph():
    ...
    def add_action_level(self, level):
        ...
        # a_nodes starts from empty
        self.a_levels.append(set())  # set of a_nodes - empty to start
        # all actions
        for action in self.all_actions:
            # define action node
            node_a = PgNode_a(action)
            # for all state node that from state level under goes through action node
            for node_s in self.s_levels[level]:
                #   add action_node to current level
    ...
    def inconsistent_effects_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        #  check for  common element exist bettween node_a1 effect add and node a2  effect rem 
    ...
    def interference_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        # check for  common element exist bettween node_a1 effect add and node a2 in precond_neg,precond_pos,effect_add,effect_rem
    ...
    def competing_needs_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        for node1_parent in node_a1.parents:
            for node2_parent in node_a2.parents:
                               #check if node1_parent.is_mutex(node2_parent)
    ...
    def negation_mutex(self, node_s1: PgNode_s, node_s2: PgNode_s) -> bool:
        ...
        # returning if node_s1=node_s2 and node_s1.is_pos not equal to s2's
